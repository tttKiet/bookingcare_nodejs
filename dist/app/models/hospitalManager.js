...
module.exports = function (sequelize, DataTypes) {
  var HospitalManager = /*#__PURE__*/function (_Model) {
    _inherits(HospitalManager, _Model);
    var _super = _createSuper(HospitalManager);
    function HospitalManager() {
      _classCallCheck(this, HospitalManager);
      return _super.apply(this, arguments);
    }
    _createClass(HospitalManager, null, [{
      key: "associate",
      value:
      /**
