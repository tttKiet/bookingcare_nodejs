...
module.exports = function (sequelize, DataTypes) {
  var HealthFacility = /*#__PURE__*/function (_Model) {
    _inherits(HealthFacility, _Model);
    var _super = _createSuper(HealthFacility);
    function HealthFacility() {
      _classCallCheck(this, HealthFacility);
      return _super.apply(this, arguments);
    }
    _createClass(HealthFacility, null, [{
      key: "associate",
      value:
      /**
