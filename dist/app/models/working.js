...
module.exports = function (sequelize, DataTypes) {
  var Working = /*#__PURE__*/function (_Model) {
    _inherits(Working, _Model);
    var _super = _createSuper(Working);
    function Working() {
      _classCallCheck(this, Working);
      return _super.apply(this, arguments);
    }
    _createClass(Working, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        ...
        Working.hasMany(models.HealthExaminationSchedule, {
          foreignKey: "workingId"
        });
      }
    }]);
  ...
  Working.init({
    ...
    endDate: {
      type: DataTypes.DATE,
      validate: {
        isEndDateAfterStartDate: function isEndDateAfterStartDate(value) {
