...
module.exports = function (sequelize, DataTypes) {
  var Staff = /*#__PURE__*/function (_Model) {
    _inherits(Staff, _Model);
  ...
  Staff.init({
    ...
    hooks: {
      beforeCreate: function () {
        var _beforeCreate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(staff, options) {
          var defaultRole;
